...
namespace eRestaurant.Framework.BLL
{
    ...
    public class WaiterController
    {
        ...
        public Order GetBill(int billId)
        {
            ...
            {
                var result = from data in context.Bills
                             where data.BillID == billId // This would be the billId that they ask for
                             select new Order()
                             {
                                 BillID = data.BillID,
        ...
        public void SplitBill(int billId, List<OrderItem> updatesToOriginalBillItems,
                                List<OrderItem> newBillItems)
        {
            ...
            using(var context = new RestaurantContext())
            {
                ...
                var newBill = new Bill()
                {
                    ...
                    // TODO: thorny question about rules aroud splitting a bill for
