...
//			(presumes no overlaps can occur - i.e., two groups at teh same 
...
var step3 = from data in step2.ToList()
			select new
			{
				...
				// .FirstOrDefault() is effectibely "flattening" my collection of 1 item into a 
				// sing object whose properties I can get in Step 4 using the dot (.) operator
				CommonBilling = data.CommonBilling.FirstOrDefault()
			};
step3.Dump("Results For Step 3");
...
step4.Dump("The final, boiled-down list of table occupancy at as point in time");